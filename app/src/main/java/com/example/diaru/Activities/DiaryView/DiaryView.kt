...
@Composable
fun DiaryViewContent(diaryViewModel: DiaryViewModel, diaryCreateViewModel: DiaryCreateViewModel) {
    ...
    for (i in diaryEntries) {
        if (i.id == diaryId) {
            ...
            DiaryWriteEntry(diaryCreateViewModel, LocalContext.current, diaryEntity = i)
            break
        }
    }
...
fun DiaryViewApp(diaryViewModel: DiaryViewModel, diaryViewCreateViewModel: DiaryCreateViewModel) {
    ...
    Column {
        ...
        DiaryViewContent(diaryViewModel, diaryViewCreateViewModel)
    }
